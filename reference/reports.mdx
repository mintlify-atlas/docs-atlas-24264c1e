---
title: "JasperReports PDF generation: four TEI report types"
sidebarTitle: "Reports"
description: "The TEI generates four PDF reports via JasperReports 7: student roster, teacher log, grade list, and payment tracking, all streamed to the HTTP response."
---
