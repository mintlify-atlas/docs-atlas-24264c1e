---
title: "TEI data backup: formatted Excel export and SQL dump"
sidebarTitle: "Backup"
description: "Two admin-triggered backup formats: an Apache POI Excel workbook with four data sheets, and a full MySQL dump via mysqldump streamed to the browser."
---
