---
title: "Set up the tallerdeingles MySQL database for TEI app"
sidebarTitle: "Database Setup"
description: "Create the tallerdeingles MySQL database, configure the adminTallerIngles user, and seed the 11 required tables for the TEI system."
---
