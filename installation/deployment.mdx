---
title: "Build and deploy tallerDeInglesUAEM.war to GlassFish 7"
sidebarTitle: "Deployment"
description: "Build the Maven WAR, deploy tallerDeInglesUAEM.war to GlassFish 7 via autodeploy or the admin console, and verify all login portals load."
---
